...
>;
export const getFileURL = /* GraphQL */ `query GetFileURL($fileName: String!) {
  getFileURL(fileName: $fileName)
}
` as GeneratedQuery<
  APITypes.GetFileURLQueryVariables,
  APITypes.GetFileURLQuery
>;
...
>;
export const listBedrockKnowledgeBases = /* GraphQL */ `query ListBedrockKnowledgeBases {
  listBedrockKnowledgeBases {
    id
    name
    external
    __typename
...
` as GeneratedQuery<
  APITypes.ListBedrockKnowledgeBasesQueryVariables,
  APITypes.ListBedrockKnowledgeBasesQuery
>;
...
export const getApplication = /* GraphQL */ `query GetApplication($id: String!) {
